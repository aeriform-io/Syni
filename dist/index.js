...
// Initialize
var _argv = _yargs2.default.usage([_safe2.default.red('Usage:'), '--type, -t        {jpg,png,sgi,tif,dpx,tga,exr} (default: png)', '--start-id, -i    [num]                         (default: 1)', '--write-with, -c  [num]                         (optional)     (--render)', '--write-delay, -d [relative time]               (default: 5ms) (--render)', '--prefix, -p      [string]                      (default: frame)', '--write, -w       [num:filesize,...]', '--render, -r                                    (optional)', '--zero-byte, -z                                 (optional)     (--render)', '--shuffle                                       (optional)', '', _safe2.default.underline('Examples.'), 'syni --type png -i 5 --write 5:12kb', 'syni --type dpx --render --write 5:10.2mb,3:10.4mb,8:10mb --shuffle'].map(function (e) {
